...
def download_chapter(audio_url, filename):
    ...
    Überprüft, ob die Datei bereits existiert, und verhindert das Überschreiben.
    """
    filepath = os.path.join(AUDIO_DIR, filename)

    # Überprüfe, ob die Datei bereits existiert
    if os.path.exists(filepath):
        print(f"Die Datei '{filename}' existiert bereits. Der Download wird übersprungen.")
        return  # Beende die Funktion, ohne den Download zu starten

    # Wenn die Datei nicht existiert, wird sie heruntergeladen
